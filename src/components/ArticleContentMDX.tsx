...
const createSlug = (text: string) => {
  return text
    ...
    .replace(/--+/g, '-');    // двойные дефисы в одинарные
};
...
const components = {
  // Стандартные HTML элементы с кастомными стилями
  h1: (props: any) => {
...
export default async function ArticleContentMDX({ content }: { content: string }) {
  return (
    <MDXRemote 
      source={content}
