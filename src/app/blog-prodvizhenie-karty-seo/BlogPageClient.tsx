        ...
        <div className="container mx-auto px-4 relative z-10" style={{ maxWidth: '1440px' }}>
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-2xl text-slate-300 leading-relaxed mb-2">
              Экспертные статьи о продвижении в картах и локальном SEO
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4" style={{ maxWidth: '1440px' }}>
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-6">Последние статьи</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Практические руководства, кейсы и аналитика от экспертов UPMAP
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredArticles.map((article) => (
              <Link 
                ...
                className="group"
              >
                <article className="bg-white border border-gray-200 rounded-2xl overflow-hidden hover:shadow-2xl hover:border-blue-400 transition-all duration-300 h-full flex flex-col">
                  {/* Категория badge */}
